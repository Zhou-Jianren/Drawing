...
excel_path=f'F:/Zero/MFBP/draw/data/upset.xlsx'
...
plot_result["intersections"].set_yticks(np.arange(0, 2600, 500))
plot_result["totals"].set_xticks(np.arange(0, 2600, 500))
...
plt.savefig("F:/Zero/MFBP/draw/image/upset.png", dpi=300, format="png")
